...
import { Eye, EyeOff, ScanFace, Shield, Fingerprint } from 'lucide-react';
        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <p className="text-background/70 text-base leading-relaxed">
              Complete your KYC verification quickly and securely. Your data is protected every step of the way.
            </p>
          </div>
          <div className="space-y-4">
            {[
              { icon: <ScanFace size={18} />, text: 'Instant document scanning with OCR' },
              { icon: <Fingerprint size={18} />, text: 'Liveness detection & face match' },
              { icon: <Shield size={18} />, text: 'Bank-grade data encryption' },
            ].map((item, i) => (
              <div key={i} className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-full bg-background/10 flex items-center justify-center flex-shrink-0 text-background">
                  {item.icon}
                </div>
                <p className="text-background/80 text-sm">{item.text}</p>
              </div>
            ))}
          </div>
        </div>
        <div className="relative z-10">
          <p className="text-background/40 text-xs">&copy; {new Date().getFullYear()} Bureau. All rights reserved.</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          <div className="mb-8 lg:hidden">
            <svg height="20" viewBox="0 0 124 33" xmlns="http://www.w3.org/2000/svg" aria-label="PayPal">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground text-sm">Sign in to continue your verification</p>
          </div>
