    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="flex items-center justify-between mb-12">
          <div>
            <h1 className="text-4xl font-bold text-foreground mb-2">Start Verification</h1>
            <p className="text-lg text-muted-foreground">Supporting verifications in 200+ countries</p>
          </div>
          <CountrySelector />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl">
          ...
          <button
            ...
            className="group p-8 bg-card border border-border rounded-lg hover:border-primary hover:shadow-lg transition-all duration-300"
          >
            <div className="flex flex-col h-full">
              <div className="mb-6">
                <h2 className="text-2xl font-bold text-foreground mb-2">Individual Verification</h2>
                <p className="text-muted-foreground text-sm">Verify your personal identity with comprehensive KYC checks</p>
              </div>
          ...
          {/* Individual + Business Verification Card */}
          <button
            onClick={() => router.push('/merchant/onboarding')}
            className="group p-8 bg-card border-2 border-primary rounded-lg hover:shadow-lg transition-all duration-300 relative"
          >
            ...
            <div className="flex flex-col h-full">
              <div className="mb-6">
                <h2 className="text-2xl font-bold text-foreground mb-2">Individual + Business Verification</h2>
                <p className="text-muted-foreground text-sm">Verify both personal identity and business credentials in one flow</p>
              </div>
        ...
        {/* Info Section */}
        <div className="mt-16 p-6 bg-secondary/30 border border-border rounded-lg max-w-3xl">
          <h3 className="font-semibold text-foreground mb-3">Why choose combined verification?</h3>
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li className="flex gap-2">
              <span className="text-primary font-bold">•</span>
              <span>Streamlined onboarding for business accounts</span>
            </li>
            <li className="flex gap-2">
              <span className="text-primary font-bold">•</span>
              <span>Enhanced compliance and fraud prevention</span>
            </li>
            <li className="flex gap-2">
              <span className="text-primary font-bold">•</span>
              <span>Single verification process for multiple layers of trust</span>
            </li>
          </ul>
        </div>
      </main>
