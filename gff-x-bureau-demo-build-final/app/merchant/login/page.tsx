...
import { Eye, EyeOff, Building2, Shield, FileText } from 'lucide-react';
...
export default function MerchantLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      await authenticateMerchant(email, password);
        ...
        <div className="relative z-10 space-y-8">
          <div>
            <h2 className="text-4xl font-bold mb-4 text-balance leading-tight">
              Onboard your business<br />with confidence
            </h2>
            <p className="text-background/70 text-base leading-relaxed">
              Complete your KYB verification quickly and securely. Register your business and verify your identity in one seamless flow.
            </p>
          </div>
          <div className="space-y-4">
            {[
              { icon: <Building2 size={18} />, text: 'Business registration number verification' },
              { icon: <FileText size={18} />, text: 'Director identity & document checks' },
              { icon: <Shield size={18} />, text: 'AML & sanctions screening' },
            ].map((item, i) => (
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center p-6 lg:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-foreground mb-2 text-balance">Sign in to continue</h1>
            <p className="text-muted-foreground text-sm leading-relaxed">
              Access your merchant onboarding portal to complete your business verification.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-secondary/30 border-border text-foreground h-11 pr-10"
          ...
          <div className="mt-6 p-4 rounded-xl bg-secondary/40 border border-border">
            <p className="text-xs font-semibold text-foreground mb-1">Demo credentials</p>
            <p className="text-xs text-muted-foreground font-mono">merchant@demo.com / Merchant@123</p>
          </div>
